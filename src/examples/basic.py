...
if __name__ == '__main__':
    ...
    if not api_key_present:
        ...
        print("Please set it before running this example (e.g., export {FurthermoreClient.FURTHERMORE_API_KEY_ENV_VAR}=your_key).")
    else:
        print(f"Environment variable '{FurthermoreClient.FURTHERMORE_API_KEY_ENV_VAR}' is set.")
